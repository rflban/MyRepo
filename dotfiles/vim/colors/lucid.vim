...
let colorgroup['CursorLineNr'] = {"GUIFG": _cloud, "GUIBG":  _rock}
...
let colorgroup['MatchParen']   = {"GUIFG": _purple, "GUIBG":  _rock}
"let colorgroup['ModeMsg']      = {"GUIFG": _rock_dark, "GUIBG":  _turquoise}
let colorgroup['ModeMsg']      = {"GUIFG": _turquoise, "GUIBG":  _rock_dark}
...
let colorgroup['Visual']       = {"GUIFG": _rock_dark, "GUIBG":  _sap, "GUI": "bold"}
if &background == "light"
